...
This is the [R Markdown](http://rmarkdown.rstudio.com) Notebook for chapter 5: Handling Missing Data
...
md_state_extra_plot <- ggplot(md_state_extra %>% mutate(extra=ifelse(is.na(extra), -30, extra)), 
                              aes(x=extra, col=status, lty=status)) +
  geom_density(position='identity', size=1.2) + 
