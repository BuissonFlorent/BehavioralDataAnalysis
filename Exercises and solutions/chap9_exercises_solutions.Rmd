...
a)	Select only the control group (i.e., subjects with no effect) and delete the Gave variable from it. Create an ID variable that indexes the rows in your dataset. 
