...
a)	Run a hierarchical linear regression of ADR on the following variables: Country, MarketSegment, Quarter, Year, and Children. 
...
b)	Save the predicted values for all the rows in the data and calculate the average square of residuals ASR2 (i.e., the average of the squares of the difference between the true value and the predicted value)
...
a)	Calculate the difference between the square roots of ASR1 and ASR2. What is the meaning of this number?
